...
public class ManoOculta : MonoBehaviour
{
    [Header("Variables")]
    ...
    // ---------- Hacer mano izquierda invisible ----------
    void HideLeftHandMesh()
    {
    // Coge todos los renderers de la mano izquierda (mallas + uñas, si las hubiese)
        var renderers = leftHand.GetComponentsInChildren<SkinnedMeshRenderer>(true);

        foreach (var r in renderers)
            r.enabled = false;          // simplemente los apagamos
    }
