...
public class VRMirrorRight : MonoBehaviour
{
    ...
    {
        MirrorFromTo(rightT, leftT); //Llamamos a la funcion MirrorFromTo(origen,destino), para que la mano derecha imite a la izquierda   
    }
